...
void MethodSwizzle1(Class aClass, SEL orig_sel, SEL alt_sel)
{
...
/* temporary home */
void MethodSwizzle2(Class aClass, SEL orig_sel, SEL alt_sel, BOOL isClass)
{
    Method orig_method = nil, alt_method = nil;
    ...
    if ((orig_method != nil) && (alt_method != nil))
        ...
        orig_method->method_imp = alt_method->method_imp;
        alt_method->method_imp = temp2;
	} else NSLog(@"ERROR!: Attempt to swizzle nonexistent methods! %@", NSStringFromSelector(orig_sel), NSStringFromSelector(alt_sel));
}
