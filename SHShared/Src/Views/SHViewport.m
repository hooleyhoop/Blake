...
{
	logInfo(@"keyDown.m: is keyDown theEvkeyDownent? ");
}

- (void) willCloseWindow
{
//warning!	removed because of compiler warning [_theViewController willBeRemovedFromViewPort];
...
//warning!	removed because of compiler warning [_theViewController willBeAddedToViewPort];
...
- (void) setTheSHSwapableView: (id<SHCustomViewProtocol>) aTheSHSwapableView
{
	...
	/* resize to fit */
	[_theSHSwapableView setFrame:[self frame]];
